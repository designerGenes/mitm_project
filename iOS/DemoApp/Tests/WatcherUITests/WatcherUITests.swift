/// XCUITests that demonstrate calling the Watcher Python backend with
/// realistic queries through the WatcherClient Swift library.
///
/// Prerequisites:
...
final class WatcherUITests: XCTestCase {
    ...
    func testSpanStartStop() throws {
        try Watcher.startSpan(named: "ui_lifecycle")
    ...
    func testSpanAppearsInStatus() throws {
        try Watcher.startSpan(named: "status_span")
        try Watcher.stopSpan()
    ...
    func testCaptureGETResponseStatus() throws {
        try Watcher.startSpan(named: "ui_get_status")
    ...
    func testCapturePOSTRequestBody() throws {
        try Watcher.startSpan(named: "ui_post_body")
    ...
    func testResponseBodyKeyPath() throws {
        try Watcher.startSpan(named: "ui_keypath")
    ...
    func testResponseBodyContains() throws {
        try Watcher.startSpan(named: "ui_contains")
    ...
    func testRequestHeaderValue() throws {
        try Watcher.startSpan(named: "ui_req_header")
    ...
    func testRequestQueryParams() throws {
        try Watcher.startSpan(named: "ui_params")
    ...
    func testCountExchanges() throws {
        try Watcher.startSpan(named: "ui_count")
    ...
    func testOccurrenceIndex() throws {
        try Watcher.startSpan(named: "ui_occurrence")
    ...
    func testMultipleQuestionsInSingleQuery() throws {
        try Watcher.startSpan(named: "ui_multi_q")
    ...
    func testMultipleQuestionsAnswerValues() throws {
        try Watcher.startSpan(named: "ui_multi_vals")
    ...
    func testSpanTotalRequestCount() throws {
        try Watcher.startSpan(named: "ui_span_count")
    ...
    func testSpanDomainsContacted() throws {
        try Watcher.startSpan(named: "ui_domains")
    ...
    func testQueryNonExistentDomainReturnsNotFound() throws {
        try Watcher.startSpan(named: "ui_notfound")
        proxyGET("http://httpbin.org/get")
        waitForCapture()
        try Watcher.stopSpan()
