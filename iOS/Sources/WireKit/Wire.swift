...
/// Static facade for the Wire client — the primary API for iOS UI tests.
///
/// Usage:
/// ```swift
...
/// ```
public enum Wire {
    private static var _client = WireClient()

    /// The underlying client instance.
    public static var client: WireClient { _client }
    ...
    public static func configure(
        ...
        _client = WireClient(port: port, host: host, session: session, timeout: timeout)
    }
